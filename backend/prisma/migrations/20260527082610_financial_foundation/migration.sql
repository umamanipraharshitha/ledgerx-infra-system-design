...
-- CreateEnum
CREATE TYPE "LedgerType" AS ENUM ('SUBSCRIPTION_PAYMENT', 'USAGE_CHARGE', 'REFUND', 'CREDIT', 'MANUAL_ADJUSTMENT');
...
-- CreateIndex
CREATE INDEX "Usage_tenantId_idx" ON "Usage"("tenantId");

-- CreateIndex
CREATE INDEX "Usage_createdAt_idx" ON "Usage"("createdAt");

-- CreateIndex
CREATE INDEX "Usage_tenantId_createdAt_idx" ON "Usage"("tenantId", "createdAt");
